# Generated by Django 3.0.2 on 2020-01-04 20:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(default=2007, verbose_name='Дата выхода')),
                ...
                ('fees_in_worold', models.PositiveIntegerField(default=0, help_text='Указывать сумму в долларах', verbose_name='Сборы в мире')),
                ('url', models.SlugField(max_length=160, unique=True)),
                ...
                ('directors', models.ManyToManyField(related_name='film_actor', to='movies.Actor', verbose_name='актёры')),
